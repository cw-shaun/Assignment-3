...
namespace StockApi.Tests.Controllers
{
    ...
    {
        private readonly Mock<StockService> _mockStockService;
        private readonly Mock<IMapper> _mockMapper;
        private readonly StockController _controller;

        public StockControllerTests()
        {
            _mockStockService = new Mock<StockService>();
            _mockMapper = new Mock<IMapper>();
            _controller = new StockController(_mockStockService.Object, _mockMapper.Object);
        }

        [Fact]
        public void SayHello_ReturnsOkWithHelloMessage()
        {
            // Act
            var result = _controller.SayHello();
